...
def testprobC(traindata):
	...
	# print counter
	# print Listfor1_1
	Listfor0_0 = np.array(Listfor0_0)/float(countfor0)
	Listfor0_1 = np.array(Listfor0_1)/float(countfor0)
	Listfor1_0 = np.array(Listfor1_0)/float(countfor1)
	Listfor1_1 = np.array(Listfor1_1)/float(countfor1)
	# print Listfor1_1
	# print Listfor0_1
	Returnlist = []
...
def classifierProb(traindata):
	...
	probfor0= float(countfor0/float(len(traindata)))
	probfor1= float(countfor1/float(len(traindata)))
